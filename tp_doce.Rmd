...
# for (i in 1:length(cautious_prediction)){
#   if(cautious[i] != 1 && cautious[i] != 2 && cautious[i] != 4 && cautious[i] != 8 && cautious[i] != 16){
#     #compter les fois ou on prédit des sous ensembles hors singletons
#   }
# }
```
